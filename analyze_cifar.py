...
# Tất cả anchor trên Máy 1 để nhất quán phần cứng; federated (B2/B3) dùng rendezvous.
# Giữ run cũ (m2 no-rv cho B1/B2, m1 no-rv cho B3) để đối chiếu before/after ở §3.4.
REL_B1 = Path("exp_cifar_centralized") / "m1"
REL_B2 = Path("exp_cifar_fed_1machine") / "m1_rv"
